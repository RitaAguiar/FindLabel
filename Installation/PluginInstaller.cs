...
{
    [RunInstaller(true)]
    public partial class PluginInstaller : System.Configuration.Install.Installer
    {
        ...
        public override void Uninstall(System.Collections.IDictionary stateSaver)
        {
            ...
            rkbase.DeleteSubKeyTree("SOFTWARE\\Wow6432Node\\RitaAguiarPlugins\\RitaAguiarPlugins 2021");
            //2 August 2019: End.
        ...
        public override void Install(System.Collections.IDictionary stateSaver)
        {
            ...
            //{
                ...
                Microsoft.Win32.RegistryKey rkbase = null;
                rkbase = Microsoft.Win32.RegistryKey.OpenBaseKey(Microsoft.Win32.RegistryHive.LocalMachine, Microsoft.Win32.RegistryView.Registry64);
                rkbase.CreateSubKey("SOFTWARE\\Wow6432Node\\RitaAguiarPlugins\\RitaAguiarPlugins 2021", Microsoft.Win32.RegistryKeyPermissionCheck.ReadWriteSubTree).SetValue("XceedVersion", typeof(Xceed.Wpf.Toolkit.PropertyGrid.PropertyGrid).Assembly.FullName);
                //rkbase.CreateSubKey("SOFTWARE\\Wow6432Node\\RitaAguiarPlugins\\RitaAguiarPlugins 2021", Microsoft.Win32.RegistryKeyPermissionCheck.ReadWriteSubTree).SetValue("OokiiVersion", typeof(Ookii.Dialogs.Wpf.CredentialDialog).Assembly.FullName);
                //2 August 2019: End.
                ...
                XElementAddIn.Add(new XElement("FullClassName", myAddinDLL + ".Application"));
                XElementAddIn.Add(new XElement("VendorId", "RitaAguiar"));
                XElementAddIn.Add(new XElement("VendorDescription", "RitaAguiarPlugins, rita.aguiar@outlook.com"));
